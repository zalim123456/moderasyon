...
if(!args[0]) return message.channel.send("Doğru Kullanım: `t.botkoruma aç/kapat/izin-ver`")
if(args[0] === "aç"){
if(!kanal) return message.channel.send("Doğru Kullanım: `t.botkoruma aç #logkanal`")
